...
namespace Stump.Server.WorldServer.Game.Fights.Buffs
{
    public class StateBuff : Buff
    {
        ...
        {
            if (Delay == 0)
                return new FightTemporaryBoostStateEffect(Id, Target.Id, Duration, (sbyte)Dispellable, (short)Spell.Id, EffectFix?.ClientEffectId ?? Effect.Id, 0, 1, (short)State.Id);
