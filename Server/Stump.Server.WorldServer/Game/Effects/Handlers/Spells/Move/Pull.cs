...
namespace Stump.Server.WorldServer.Game.Effects.Handlers.Spells.Move
{
    ...
    public class Pull : SpellEffectHandler
    {
        ...
        protected override bool InternalApply()
        {
            ...
            {
                if (actor.HasState((int)SpellStatesEnum.INDEPLACABLE_97) || actor.HasState((int)SpellStatesEnum.ENRACINE_6) || actor.HasState((int)SpellStatesEnum.INEBRANLABLE_157))
                    continue;
