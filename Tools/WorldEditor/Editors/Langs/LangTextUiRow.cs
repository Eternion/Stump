...
{
    public sealed class LangTextUiRow : LangGridRow
    {
        private readonly LangTextUi m_record;
        private string m_text;

        public LangTextUiRow()
        {
        }

        public LangTextUiRow(LangTextUi record)
        {
            m_record = record;
        }
