...
// From 'ChatServerWithObjectMessage.xml' the '30/06/2011 11:40:11'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Messages
{
	public class ChatServerWithObjectMessage : ChatServerMessage
	{
		...
		public ChatServerWithObjectMessage(byte channel, string content, int timestamp, string fingerprint, int senderId, string senderName, int senderAccountId, IEnumerable<Types.ObjectItem> objects)
