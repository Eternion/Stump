...
// From 'ChatClientMultiWithObjectMessage.xml' the '30/06/2011 11:40:11'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Messages
{
	public class ChatClientMultiWithObjectMessage : ChatClientMultiMessage
	{
		...
		public ChatClientMultiWithObjectMessage(string content, byte channel, IEnumerable<Types.ObjectItem> objects)
