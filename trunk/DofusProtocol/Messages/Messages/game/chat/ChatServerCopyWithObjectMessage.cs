...
// From 'ChatServerCopyWithObjectMessage.xml' the '30/06/2011 11:40:11'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Messages
{
	public class ChatServerCopyWithObjectMessage : ChatServerCopyMessage
	{
		...
		public ChatServerCopyWithObjectMessage(byte channel, string content, int timestamp, string fingerprint, int receiverId, string receiverName, IEnumerable<Types.ObjectItem> objects)
