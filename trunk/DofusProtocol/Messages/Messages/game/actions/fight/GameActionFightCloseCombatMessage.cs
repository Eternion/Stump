...
// From 'GameActionFightCloseCombatMessage.xml' the '15/06/2011 01:38:40'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Messages
{
	public class GameActionFightCloseCombatMessage : AbstractGameActionFightTargetedAbilityMessage
	{
		...
		public GameActionFightCloseCombatMessage(short actionId, int sourceId, short destinationCellId, byte critical, bool silentCast, int weaponGenericId)
