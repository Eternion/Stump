...
// Generated on 08/11/2013 11:28:53
using System;
...
namespace Stump.DofusProtocol.Messages
{
    public class ExchangeMountSterilizeFromPaddockMessage : Message
    {
        ...
        {
            return sizeof(short) + Encoding.UTF8.GetByteCount(name) + sizeof(short) + sizeof(short) + sizeof(short) + Encoding.UTF8.GetByteCount(sterilizator);
        }
