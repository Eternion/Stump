...
// From 'ExchangeGuildTaxCollectorGetMessage.xml' the '24/06/2011 12:04:53'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Messages
{
	public class ExchangeGuildTaxCollectorGetMessage : Message
	{
		...
		public ExchangeGuildTaxCollectorGetMessage(string collectorName, short worldX, short worldY, int mapId, string userName, double experience, Types.ObjectItemQuantity[] objectsInfos)
		{
