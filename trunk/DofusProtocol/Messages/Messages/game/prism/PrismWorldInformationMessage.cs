...
// From 'PrismWorldInformationMessage.xml' the '15/06/2011 01:39:09'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Messages
{
	public class PrismWorldInformationMessage : Message
	{
		...
		public Types.PrismConquestInformation[] conquetesInformation;
		
		public PrismWorldInformationMessage()
		{
		}
		
		public PrismWorldInformationMessage(int nbSubOwned, int subTotal, int maxSub, Types.PrismSubAreaInformation[] subAreasInformation, int nbConqsOwned, int conqsTotal, Types.PrismConquestInformation[] conquetesInformation)
		{
		...
		public override void Serialize(IDataWriter writer)
		{
			...
			for (int i = 0; i < subAreasInformation.Length; i++)
			{
				subAreasInformation[i].Serialize(writer);
			}
			writer.WriteInt(nbConqsOwned);
			writer.WriteInt(conqsTotal);
			writer.WriteUShort((ushort)conquetesInformation.Length);
			for (int i = 0; i < conquetesInformation.Length; i++)
			{
				conquetesInformation[i].Serialize(writer);
			}
		}
		...
		public override void Deserialize(IDataReader reader)
		{
			...
			conquetesInformation = new Types.PrismConquestInformation[limit];
			for (int i = 0; i < limit; i++)
			{
				conquetesInformation[i] = new Types.PrismConquestInformation();
