...
// From 'PrismWorldInformationMessage.xml' the '30/06/2011 11:40:21'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Messages
{
	public class PrismWorldInformationMessage : Message
	{
		...
		public override void Deserialize(IDataReader reader)
		{
			...
			for (int i = 0; i < limit; i++)
			{
				(conquetesInformation as Types.PrismConquestInformation[])[i] = new Types.PrismConquestInformation();
				(conquetesInformation as Types.PrismConquestInformation[])[i].Deserialize(reader);
			}
		}
	}
}
