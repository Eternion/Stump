...
// From 'GuildInfosUpgradeMessage.xml' the '30/06/2011 11:40:16'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Messages
{
	public class GuildInfosUpgradeMessage : Message
	{
		...
		public IEnumerable<byte> spellLevel;
		
		public GuildInfosUpgradeMessage()
		{
		}
		
		public GuildInfosUpgradeMessage(byte maxTaxCollectorsCount, byte taxCollectorsCount, short taxCollectorLifePoints, short taxCollectorDamagesBonuses, short taxCollectorPods, short taxCollectorProspecting, short taxCollectorWisdom, short boostPoints, IEnumerable<short> spellId, IEnumerable<byte> spellLevel)
		{
		...
		public override void Deserialize(IDataReader reader)
		{
			...
			for (int i = 0; i < limit; i++)
			{
				(spellLevel as byte[])[i] = reader.ReadByte();
			}
		}
	}
}
