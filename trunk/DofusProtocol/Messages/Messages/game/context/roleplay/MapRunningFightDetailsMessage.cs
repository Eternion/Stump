...
// From 'MapRunningFightDetailsMessage.xml' the '30/06/2011 11:40:13'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Messages
{
	public class MapRunningFightDetailsMessage : Message
	{
		...
		public MapRunningFightDetailsMessage(int fightId, IEnumerable<string> names, IEnumerable<short> levels, byte teamSwap, IEnumerable<bool> alives)
		{
