...
// From 'GameFightSpectateMessage.xml' the '22/08/2011 17:22:54'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Messages
{
	public class GameFightSpectateMessage : Message
	{
		...
		public override void Deserialize(IDataReader reader)
		{
			...
			{
				(effects as Types.FightDispellableEffectExtendedInformations[])[i] = Types.ProtocolTypeManager.GetInstance<Types.FightDispellableEffectExtendedInformations>(reader.ReadShort());
