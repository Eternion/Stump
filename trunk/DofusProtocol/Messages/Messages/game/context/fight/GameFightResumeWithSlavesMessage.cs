...
// From 'GameFightResumeWithSlavesMessage.xml' the '30/06/2011 11:40:12'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Messages
{
	public class GameFightResumeWithSlavesMessage : GameFightResumeMessage
	{
		...
		public GameFightResumeWithSlavesMessage(IEnumerable<Types.FightDispellableEffectExtendedInformations> effects, IEnumerable<Types.GameActionMark> marks, short gameTurn, IEnumerable<Types.GameFightSpellCooldown> spellCooldowns, byte summonCount, byte bombCount, IEnumerable<Types.GameFightResumeSlaveInfo> slavesInfo)
