...
// From 'IdentificationWithLoginTokenMessage.xml' the '15/06/2011 01:38:39'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Messages
{
	public class IdentificationWithLoginTokenMessage : IdentificationMessage
	{
		...
		public IdentificationWithLoginTokenMessage(Types.Version version, string login, string password, bool autoconnect, string loginToken)
