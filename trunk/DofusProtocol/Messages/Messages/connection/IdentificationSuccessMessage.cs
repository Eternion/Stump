...
// From 'IdentificationSuccessMessage.xml' the '30/06/2011 11:40:08'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Messages
{
	public class IdentificationSuccessMessage : Message
	{
		...
		public IdentificationSuccessMessage(bool hasRights, bool wasAlreadyConnected, string nickname, int accountId, byte communityId, string secretQuestion, double remainingSubscriptionTime)
		{
