...
// From 'StartupActionAddObject.xml' the '05/11/2011 17:26:03'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Types
{
	public class StartupActionAddObject
	{
		...
		public virtual void Deserialize(IDataReader reader)
		{
			...
			{
				(items as ObjectItemMinimalInformation[])[i] = new Types.ObjectItemMinimalInformation();
				(items as Types.ObjectItemMinimalInformation[])[i].Deserialize(reader);
			}
		}
	}
}
