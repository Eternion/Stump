...
// From 'FightTriggeredEffect.xml' the '24/06/2011 12:04:57'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Types
{
	public class FightTriggeredEffect : AbstractFightDispellableEffect
	{
		...
		public FightTriggeredEffect(int uid, int targetId, short turnDuration, byte dispelable, short spellId, int arg1, int arg2, int arg3, short delay)
