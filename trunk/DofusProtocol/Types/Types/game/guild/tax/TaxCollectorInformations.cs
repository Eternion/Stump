...
// From 'TaxCollectorInformations.xml' the '24/06/2011 12:04:59'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Types
{
	public class TaxCollectorInformations
	{
		...
		public TaxCollectorInformations(int uniqueId, short firtNameId, short lastNameId, Types.AdditionalTaxCollectorInformations additonalInformation, short worldX, short worldY, short subAreaId, byte state, Types.EntityLook look, int kamas, double experience, int pods, int itemsValue)
		{
