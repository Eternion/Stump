...
// From 'FriendSpouseOnlineInformations.xml' the '14/06/2011 11:32:49'
using System;
...
namespace Stump.DofusProtocol.Types
{
	public class FriendSpouseOnlineInformations : FriendSpouseInformations
	{
		...
		public FriendSpouseOnlineInformations(int spouseId, string spouseName, byte spouseLevel, byte breed, byte sex, Types.EntityLook spouseEntityLook, Types.BasicGuildInformations guildInfo, byte alignmentSide, bool inFight, bool followSpouse, bool pvpEnabled, int mapId, short subAreaId)
