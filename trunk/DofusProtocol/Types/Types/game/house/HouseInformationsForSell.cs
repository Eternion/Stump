...
// From 'HouseInformationsForSell.xml' the '30/06/2011 11:40:24'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Types
{
	public class HouseInformationsForSell
	{
		...
		public HouseInformationsForSell(int modelId, string ownerName, bool ownerConnected, short worldX, short worldY, short subAreaId, byte nbRoom, byte nbChest, IEnumerable<int> skillListIds, bool isLocked, int price)
		{
