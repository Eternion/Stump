...
// From 'PartyMemberInformations.xml' the '14/06/2011 11:32:48'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Types
{
	public class PartyMemberInformations : CharacterMinimalPlusLookInformations
	{
		...
		public PartyMemberInformations(int id, byte level, string name, Types.EntityLook entityLook, int lifePoints, int maxLifePoints, short prospecting, byte regenRate, short initiative, bool pvpEnabled, byte alignmentSide)
