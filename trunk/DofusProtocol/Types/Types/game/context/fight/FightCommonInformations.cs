...
// From 'FightCommonInformations.xml' the '30/06/2011 11:40:22'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Types
{
	public class FightCommonInformations
	{
		...
		public FightCommonInformations(int fightId, byte fightType, IEnumerable<Types.FightTeamInformations> fightTeams, IEnumerable<short> fightTeamsPositions, IEnumerable<Types.FightOptionsInformations> fightTeamsOptions)
		{
		...
		public virtual void Deserialize(IDataReader reader)
		{
			...
			{
				(fightTeams as Types.FightTeamInformations[])[i] = ProtocolTypeManager.GetInstance<Types.FightTeamInformations>(reader.ReadShort());
