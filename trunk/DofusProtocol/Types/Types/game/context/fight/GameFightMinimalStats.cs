...
// From 'GameFightMinimalStats.xml' the '05/11/2011 17:26:01'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Types
{
	public class GameFightMinimalStats
	{
		...
		public GameFightMinimalStats(int lifePoints, int maxLifePoints, int baseMaxLifePoints, int permanentDamagePercent, int shieldPoints, short actionPoints, short movementPoints, int summoner, bool summoned, short neutralElementResistPercent, short earthElementResistPercent, short waterElementResistPercent, short airElementResistPercent, short fireElementResistPercent, short dodgePALostProbability, short dodgePMLostProbability, short tackleBlock, short tackleEvade, sbyte invisibilityState)
		{
