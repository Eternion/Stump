...
// From 'FightTeamInformations.xml' the '30/06/2011 11:40:22'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Types
{
	public class FightTeamInformations : AbstractFightTeamInformations
	{
		...
		public FightTeamInformations(byte teamId, int leaderId, byte teamSide, byte teamTypeId, IEnumerable<Types.FightTeamMemberInformations> teamMembers)
