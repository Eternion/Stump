...
// From 'PaddockContentInformations.xml' the '03/10/2011 12:47:13'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Types
{
	public class PaddockContentInformations : PaddockInformations
	{
		...
		public PaddockContentInformations(short maxOutdoorMount, short maxItems, int paddockId, short worldX, short worldY, int mapId, short subAreaId, IEnumerable<Types.MountInformationsForPaddock> mountsInformations)
