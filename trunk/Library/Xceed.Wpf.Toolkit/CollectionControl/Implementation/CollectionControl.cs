...
namespace Xceed.Wpf.Toolkit
{
  public class CollectionControl : Control
  {
    ...
    public static readonly DependencyProperty ItemsSourceTypeProperty = DependencyProperty.Register( "ItemsSourceType", typeof( Type ), typeof( CollectionControl ),
        new UIPropertyMetadata( null, ItemsSourceTypeChanged ) );
    ...
    public static readonly DependencyProperty NewItemTypesProperty = DependencyProperty.Register("NewItemTypes", typeof(IList), typeof(CollectionControl), new UIPropertyMetadata(new List<Type>(), NewItemTypesPropertyChanged));

      private static void NewItemTypesPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
      {
