...
namespace Stump.Server.WorldServer.Database.Interactives
{
    ...
    public class InteractiveTemplateSkills : IManualGeneratedRecord
    {
        ...
        {
            var table = new DatabaseTable("interactives_templates_skills", provider);

            table.Columns.Add(new DatabaseColumn("InteractiveTemplateId", table)
            {
