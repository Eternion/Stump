...
namespace Stump.Server.WorldServer.Database.Spells
{
    ...
    public sealed class SpellLevelTemplate : WorldBaseRecord<SpellLevelTemplate>
    {
       ...
       public List<EffectDice> Effects
       {
           get
           {
               return m_effects ?? ( m_effects = new List<EffectDice>(RawEffects.Select(entry => EffectManager.Instance.ConvertExportedEffect(entry) as EffectDice)) );
           }
           set
           {
               m_effects = value;
       ...
       public List<EffectDice> CritialEffects
       {
           get
           {
               return m_criticalEffects ?? ( m_criticalEffects = new List<EffectDice>(RawCriticalEffect.Select(entry => EffectManager.Instance.ConvertExportedEffect(entry) as EffectDice)) );
           }
           set
           {
