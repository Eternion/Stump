...
namespace Stump.Server.WorldServer.Database
{
    ...
    {
        public static string FetchQuery = "SELECT * FROM characters LEFT JOIN characters_spells ON characters_spells.OwnerId = characters.Id";
    ...
    public partial class CharacterRecord : IAutoGeneratedRecord
    {
