...
{
    public class SadidaBreed : BaseBreed
    {
        public override PlayableBreedEnum Id
        {
            get
            {
                return PlayableBreedEnum.Sadida;
            }
        }

        protected override void OnInitialize()
        {
            StartSpells.Add(SpellIdEnum.Bramble, 65);
            StartSpells.Add(SpellIdEnum.ParalyzingPoison, 66);
            StartSpells.Add(SpellIdEnum.TheBlock, 67);
        }

        public override MapIdEnum StartMap
        {
            get { return MapIdEnum.Map_6552; }
        }
