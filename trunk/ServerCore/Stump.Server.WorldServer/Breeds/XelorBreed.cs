...
{
    public class XelorBreed : BaseBreed
    {
        public override PlayableBreedEnum Id
        {
            get
            {
                return PlayableBreedEnum.Xelor;
            }
        }

        protected override void OnInitialize()
        {
            StartSpells.Add(SpellIdEnum.Counter, 65);
            StartSpells.Add(SpellIdEnum.SlowDown, 66);
            StartSpells.Add(SpellIdEnum.Hand, 67);
        }

        public override MapIdEnum StartMap
        {
            get { return MapIdEnum.Map_6553; }
        }
