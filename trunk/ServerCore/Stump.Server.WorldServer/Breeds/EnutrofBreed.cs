...
{
    public class EnutrofBreed : BaseBreed
    {
        public override PlayableBreedEnum Id
        {
            get
            {
                return PlayableBreedEnum.Enutrof;
            }
        }

        protected override void OnInitialize()
        {
            StartSpells.Add(SpellIdEnum.CoinsThrowing, 65);
            StartSpells.Add(SpellIdEnum.ShovelThrowing, 66);
            StartSpells.Add(SpellIdEnum.LivingBag, 67);
        }

        public override MapIdEnum StartMap
        {
            get { return MapIdEnum.Map_6550; }
        }
