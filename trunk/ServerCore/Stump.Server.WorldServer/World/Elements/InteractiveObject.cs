...
namespace Stump.Server.WorldServer.Global.Maps
{
    public class InteractiveObject
    {
        ...
        public InteractiveObject(uint elementId, int elementType, Dictionary<uint, SkillBase> skills, CellData cell)
        {
            ElementId = elementId;
            ElementType = elementType;
            Skills = skills;
        ...
        public InteractiveElement ToNetworkElement(WorldClient client)
        {
            ...
            return new InteractiveElement(ElementId, ElementType, enabledSkills, disabledSkills);
        }
    }
}