...
namespace Stump.Server.WorldServer.Spells
{
    public static class SpellManager
    {
        ...
        {
            m_spellTemplates = DataLoader.LoadData<SpellTemplate>().ToDictionary(s => s.id);
            var levelTemplates = DataLoader.LoadDataById<SpellLevelTemplate>(entry => (int)entry.id);
