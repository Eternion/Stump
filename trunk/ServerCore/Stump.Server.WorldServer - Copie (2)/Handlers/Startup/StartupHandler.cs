...
namespace Stump.Server.WorldServer.Handlers
{
    ...
    {
        /// <summary>
        /// Activate or Desactivate the startup actions for the players
        /// </summary>
        [Variable]
        public static bool EnableStartupActions = true;
        ...
        public static void SendStartupActionsListMessage(WorldClient client)
        {
            IEnumerable<StartupActionAddObject> startupsActions =
                client.WorldAccount.StartupActions.Select(
