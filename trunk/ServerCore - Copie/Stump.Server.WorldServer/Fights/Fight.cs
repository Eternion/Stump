...
namespace Stump.Server.WorldServer.Fights
{
    ...
    public class Fight : IInstance, IContext, IDisposable
    {
        ...
        public void StartingFight()
        {
            ...
            Do(character => PrepareFight(character, character.FightGroup));
        }
        ...
        private void OnChangePreplacementPosition(FightGroupMember fighter, ObjectPosition objectPosition)
        {
            Do(character =>
        ...
        {
            Do(charac => ContextHandler.SendGameFightTurnReadyRequestMessage(charac.Client, fighter.Entity));
        }
        ...
        public bool CanCastSpell(FightGroupMember caster, CellLinked cell, SpellLevel spell)
        {
            return true;
        }
        ...
        public IEnumerable<FightGroupMember> GetAllFighters(CellLinked cell)
        {
        ...
        public FightGroupMember GetOneFighter(CellLinked cell)
        {
