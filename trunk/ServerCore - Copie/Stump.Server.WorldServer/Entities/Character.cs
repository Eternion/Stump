...
namespace Stump.Server.WorldServer.Entities
{
    public partial class Character : LivingEntity, IPacketReceiver
    {
            ...
            : base(record.Id)
        {
            ...
            Position = new ObjectPosition(World.Instance.Maps[record.MapId], record.CellId, record.Direction);
        ...
        public void ChangeMap(Map nextMap, ushort cellId, DirectionsEnum direction)
        {
            ...
            Position.ChangeLocation(new ObjectPosition(nextMap, cellId, direction));
