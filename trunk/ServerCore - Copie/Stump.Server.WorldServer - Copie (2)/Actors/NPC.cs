...
namespace Stump.Server.WorldServer.Entities
{
    public class NPC : Actor, ITrader, IExchanger
    {
        ...
        protected NPC(long id, ExtendedLook look, VectorIsometric position, uint npcId, bool sex,uint specialArtworkId, bool canGiveQuest)
        ...
        public GameRolePlayNpcInformations ToGameRolePlayNpcInformations()
        {
